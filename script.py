...
def streamlit_app():    
    ...
    # Logo and Title
    st.write('<div style="display: flex; flex-direction: row; align-items: center; justify-content: center;"><a style="margin-right: 10px;" href="https://jssstuniv.in/#/" target="_blank"><img src="https://images.shiksha.com/mediadata/images/1563772159phpav6WRj.jpeg"/></a><h1 style="margin-left: 10px;">Image Recognition for Visually Impaired</h1></div>', unsafe_allow_html=True)
